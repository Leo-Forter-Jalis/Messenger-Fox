...
public class ProtocolTest {
    ...
    public void test(){
        assertDoesNotThrow(() ->{
            ...
            new MessageRequest(UUID.randomUUID(), new MessageDTO(UUID.randomUUID(), null, new UserDTO(UUID.randomUUID(), "TEST", "TEST", Instant.now()), UUID.randomUUID(), MessageType.TEXT.name(), "", Instant.now()),Instant.now());
            new MessageResponse(UUID.randomUUID(), new MessageDTO(UUID.randomUUID(), null, new UserDTO(UUID.randomUUID(), "TEST", "TEST", Instant.now()), UUID.randomUUID(), MessageType.TEXT.name(), "АХАХАХАХХА", null), Instant.now());
        });
    }
    @Test
    public void test2(){
